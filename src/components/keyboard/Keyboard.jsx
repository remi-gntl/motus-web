      ...
      {keyboardRows.map((row, rowIndex) => (
        ...
        >
          {row.map((key) => {
            ...
            if (status === "absent")
              bgClass = "bg-gray-600 text-white opacity-50";
            ...
            return (
              <button
                ...
                className={`${bgClass} font-bold rounded-lg cursor-pointer border-b-4 border-black/30
                active:border-b-0 active:translate-y-1 transition-all duration-100
